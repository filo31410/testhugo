...
<html lang="fr" data-fr-theme>
    ...
    <head>
        ...
        <title>Carte - Design System</title>
    ...
    <body id="top" class="fr-mb-12w">
        <div class="fr-container fr-mt-2v fr-mb-8w">
            ...
            <a href="https://gouvfr.atlassian.net/wiki/spaces/DB/pages/222331445/Carte+-+Card" target="_blank">Documentation</a>
        </div>
        <div class="fr-mb-12w">
            <div class="fr-container">
                <h4>Carte verticale</h4>
                <div class="fr-mb-6v">
                ...
                <div class="fr-mb-12v">
                    <section class="fr-accordion">
                        <h3 class="fr-accordion__title">
                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-356">Extrait de code</button>
                        </h3>
                        <div class="fr-collapse" id="snippet-356">
...
&lt;/div&gt;
                ...
                <h4>Carte verticale sans image</h4>
                <div class="fr-mb-6v">
                    <div class="fr-grid-row fr-grid-row--gutters">
                        <div class="fr-col-12 fr-col-md-3">
                ...
                <div class="fr-mb-12v">
                    <section class="fr-accordion">
                        <h3 class="fr-accordion__title">
                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-357">Extrait de code</button>
                        </h3>
                        <div class="fr-collapse" id="snippet-357">
                            <pre class=" language-html"><code>&lt;div class="fr-grid-row fr-grid-row--gutters"&gt;
    &lt;div class="fr-col-12 fr-col-md-3"&gt;
        &lt;div class="fr-card fr-enlarge-link fr-card--no-arrow"&gt;
            &lt;div class="fr-card__body"&gt;
...
&lt;/div&gt;
                ...
                <h4>Carte verticale accentuée</h4>
                <div class="fr-mb-6v">
                    <div class="fr-grid-row fr-grid-row--gutters">
                        <div class="fr-col-12 fr-col-md-3">
                ...
                <div class="fr-mb-12v">
                    <section class="fr-accordion">
                        <h3 class="fr-accordion__title">
                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-358">Extrait de code</button>
                        </h3>
                        <div class="fr-collapse" id="snippet-358">
                            <pre class=" language-html"><code>&lt;div class="fr-grid-row fr-grid-row--gutters"&gt;
    &lt;div class="fr-col-12 fr-col-md-3"&gt;
        &lt;div class="fr-card fr-enlarge-link fr-card--grey"&gt;
            &lt;div class="fr-card__body"&gt;
...
&lt;/div&gt;
                ...
                <div class="fr-mb-12v">
                    <section class="fr-accordion">
                        <h3 class="fr-accordion__title">
                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-359">Extrait de code</button>
                        </h3>
                        <div class="fr-collapse" id="snippet-359">
                            <pre class=" language-html"><code>&lt;div class="fr-grid-row fr-grid-row--gutters"&gt;
    &lt;div class="fr-col-12"&gt;
        &lt;div class="fr-card fr-enlarge-link fr-card--horizontal"&gt;
            &lt;div class="fr-card__body"&gt;
