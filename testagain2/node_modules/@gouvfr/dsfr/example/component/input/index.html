...
<html lang="fr" data-fr-theme>
    ...
    <body id="top" class="fr-mb-12w">
        <div class="fr-container fr-mt-2v fr-mb-8w">
            ...
            <a href="https://gouvfr.atlassian.net/wiki/spaces/DB/pages/217088099/Champs+de+saisie+-+Text+input" target="_blank">Documentation</a>
        </div>
        <div class="fr-mb-12w">
            <div class="fr-container">
                <div class="fr-grid-row fr-grid-row--center">
                    <div class="fr-col-md-8 fr-col-12">
                        <h4>Default input type text</h4>
                        <div class="fr-mb-6v">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-376">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-376">
...
&lt;/div&gt;
                        ...
                        <h4>Default input type number</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-input-group">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-377">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-377">
                                    <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-number"&gt;
        Label champs de saisie
    &lt;/label&gt;
...
&lt;/div&gt;
                        ...
                        <h4>Default input type search</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-input-group">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-378">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-378">
                                    <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-search"&gt;
        Label champs de saisie
    &lt;/label&gt;
...
&lt;/div&gt;
                        ...
                        <h4>Default input type tel - required field</h4>
                        <div class="fr-mb-6v">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-379">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-379">
...
&lt;/div&gt;
                        ...
                        <h4>Default input type mail - required field</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-input-group fr-input-group--error">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-380">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-380">
                                    <pre class=" language-html"><code>&lt;div class="fr-input-group fr-input-group--error"&gt;
    &lt;label class="fr-label" for="text-input-mail"&gt;
        Label champs de saisie
    &lt;/label&gt;
...
&lt;!-- aria-label mandatory to explain pattern --&gt;
                        ...
                        <h4>Default input type date - required field</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-input-group fr-input-group--error">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-381">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-381">
                                    <pre class=" language-html"><code>&lt;div class="fr-input-group fr-input-group--error"&gt;
    &lt;label class="fr-label" for="text-input-date"&gt;
        Label champs de saisie
    &lt;/label&gt;
...
&lt;/div&gt;
                        ...
                        <h4>Default input type date - avec icone calendrier</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-input-group">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-382">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-382">
                                    <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-calendar"&gt;
        Label champs de saisie
    &lt;/label&gt;
...
&lt;/div&gt;
                        ...
                        <h4>Default input type textarea</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-input-group">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-383">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-383">
                                    <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="textarea"&gt;
        Label champs de saisie
    &lt;/label&gt;
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-384">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-384">
                                    <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-password"&gt;
        Label champs de saisie
    &lt;/label&gt;
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-385">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-385">
                                    <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-button"&gt;
        Label champs de saisie
    &lt;/label&gt;
...
&lt;/div&gt;
                        ...
                        <h4>Default input with placeholder</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-input-group">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-386">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-386">
                                    <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-placeholder"&gt;
        Label champs de saisie
    &lt;/label&gt;
...
&lt;/div&gt;
                        ...
                        <h4>Default input with value</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-input-group">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-387">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-387">
                                    <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-value"&gt;
        Label champs de saisie
    &lt;/label&gt;
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-388">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-388">
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-389">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-389">
                                    <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-hint"&gt;
        Label champs de saisie
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-390">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-390">
                                    <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-icon"&gt;
        Label champs de saisie
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-391">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-391">
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-392">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-392">
                                    <pre class=" language-html"><code>&lt;div class="fr-input-group fr-input-group--error"&gt;
    &lt;label class="fr-label" for="text-input-error"&gt;
        Label champs de saisie
    &lt;/label&gt;
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-393">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-393">
                                    <pre class=" language-html"><code>&lt;div class="fr-input-group"&gt;
    &lt;label class="fr-label" for="text-input-groups1"&gt;
        Label champs de saisie
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-394">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-394">
                                    <pre class=" language-html"><code>&lt;div class="fr-input-group fr-input-group--error"&gt;
    &lt;label class="fr-label" for="text-input-groups2"&gt;
        Label champs de saisie
    &lt;/label&gt;
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-395">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-395">
                                    <pre class=" language-html"><code>&lt;div class="fr-input-group fr-input-group--valid"&gt;
    &lt;label class="fr-label" for="text-input-groups3"&gt;
        Label champs de saisie
    &lt;/label&gt;
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-396">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-396">
                                    <pre class=" language-html"><code>&lt;div class="fr-input-group fr-input-group--error"&gt;
    &lt;label class="fr-label" for="text-input-groups4"&gt;
        Label champs de saisie
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-397">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-397">
                                    <pre class=" language-html"><code>&lt;div class="fr-input-group fr-input-group--valid"&gt;
    &lt;label class="fr-label" for="text-input-groups5"&gt;
        Label champs de saisie
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
