...
<html lang="fr" data-fr-theme>
    ...
    <body id="top" class="fr-mb-12w">
        <div class="fr-container fr-mt-2v fr-mb-8w">
            ...
            <a href="https://gouvfr.atlassian.net/wiki/spaces/DB/pages/967868417" target="_blank">Documentation</a>
        </div>
        <div class="fr-mb-12w">
            <div class="fr-container">
                <div class="fr-grid-row fr-grid-row--center">
                    <div class="fr-col-md-8 fr-col-12">
                        <h4>Bouton FranceConnect</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-connect-group">
                                ...
                                <p>
                                    <a href="https://franceconnect.gouv.fr/" target="_blank" title="Qu’est ce que FranceConnect ? - nouvelle fenêtre">Qu’est ce que FranceConnect ?</a>
                                </p>
                            </div>
                        </div>
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-335">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-335">
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-6v">
                            <div class="fr-connect-group">
                                ...
                                <p>
                                    <a href="https://franceconnect.gouv.fr/france-connect-plus" target="_blank" title="Qu’est ce que FranceConnect+ ? - nouvelle fenêtre">Qu’est ce que FranceConnect+ ?</a>
                                </p>
                            </div>
                        </div>
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-336">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-336">
                                    <pre class=" language-html"><code>&lt;div class="fr-connect-group"&gt;
    &lt;button class="fr-connect fr-connect--plus"&gt;
        &lt;span class="fr-connect__login"&gt;S’identifier avec&lt;/span&gt;
        &lt;span class="fr-connect__brand"&gt;FranceConnect+&lt;/span&gt;
