                ...
                <div class="fr-container">
                    <div class="fr-header__body-row">
                        <div class="fr-header__brand fr-enlarge-link">
                            <div class="fr-header__brand-top">
                                ...
                                <div class="fr-header__navbar">
                                    <button class="fr-btn--search fr-btn" data-fr-opened="false" aria-controls="modal-644" id="button-645" title="Rechercher">
                                        Rechercher
                                    </button>
                        ...
                        <div class="fr-header__tools">
                            ...
                            <div class="fr-header__search fr-modal" id="modal-644">
                                <div class="fr-container fr-container-lg--fluid">
                                    <button class="fr-btn--close fr-btn" aria-controls="modal-644" title="Fermer">
                                        Fermer
                                    </button>
                    ...
                    <nav class="fr-nav" id="header-navigation" role="navigation" aria-label="Menu principal">
                        <ul class="fr-nav__list">
                            <li class="fr-nav__item">
                                <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-649">Entrée menu</button>
                                <div class="fr-collapse fr-menu" id="menu-649">
                            ...
                            <li class="fr-nav__item">
                                <button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-650">Entrée mega menu</button>
                                <div class="fr-collapse fr-mega-menu" id="mega-menu-650">
                                    <div class="fr-container fr-container--fluid fr-container-lg">
                                        <div class="fr-grid-row fr-grid-row-lg--gutters">
                                            <div class="fr-col-12 fr-mb-n3v">
                                                <button class="fr-btn--close fr-btn" aria-controls="mega-menu-650" title="Fermer">
                                                    Fermer
                                                </button>
                                            </div>
                            ...
                            <li class="fr-nav__item">
                                <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-651" aria-current="true">Entrée menu active</button>
                                <div class="fr-collapse fr-menu" id="menu-651">
                                    <ul class="fr-menu__list">
                                        <li>
                                            <a class="fr-nav__link" href="#" target="_self">Lien de navigation</a>
                                        </li>
                            ...
                            <li class="fr-nav__item">
                                <button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-652">Entrée mega menu</button>
                                <div class="fr-collapse fr-mega-menu" id="mega-menu-652">
                                    <div class="fr-container fr-container--fluid fr-container-lg">
                                        <div class="fr-grid-row fr-grid-row-lg--gutters">
                                            <div class="fr-col-12 fr-mb-n3v">
                                                <button class="fr-btn--close fr-btn" aria-controls="mega-menu-652" title="Fermer">
                                                    Fermer
                                                </button>
                                            </div>
                                            <div class="fr-col-12 fr-col-lg-8 fr-col-offset-lg-4--right fr-mb-4v">
                            ...
                            <li class="fr-nav__item">
                                <button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-653">Entrée mega menu</button>
                                <div class="fr-collapse fr-mega-menu" id="mega-menu-653">
                                    <div class="fr-container fr-container--fluid fr-container-lg">
                                        <div class="fr-grid-row fr-grid-row-lg--gutters">
                                            <div class="fr-col-12 fr-mb-n3v">
                                                <button class="fr-btn--close fr-btn" aria-controls="mega-menu-653" title="Fermer">
                                                    Fermer
                                                </button>
                                            </div>
                                            <div class="fr-col-12 fr-col-lg-3">
                            ...
                            <li class="fr-nav__item">
                                <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-654">Entrée menu</button>
                                <div class="fr-collapse fr-menu" id="menu-654">
                                    <ul class="fr-menu__list">
                                        <li>
                                            <a class="fr-nav__link" href="#" target="_self">Lien de navigation</a>
                                        </li>
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-655">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-655">
