                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-284">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-284">
...
&lt;/p&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-285">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-285">
...
&lt;/p&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-286">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-286">
...
&lt;/p&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-287">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-287">
                                    <pre class=" language-html"><code>&lt;p class="fr-logo"&gt;
    Ministère
    &lt;br&gt;de la transition
    &lt;br&gt;écologique
...
&lt;/p&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-288">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-288">
                                    <pre class=" language-html"><code>&lt;p class="fr-logo"&gt;
    Secrétaire d’État
    &lt;br&gt;chargé(e) de
    &lt;br&gt;l’égalité entre les
...
&lt;/p&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-289">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-289">
                                    <pre class=" language-html"><code>&lt;p class="fr-logo"&gt;
    Ministère
    &lt;br&gt;de l’europe
    &lt;br&gt;et des affaires
