...
<html lang="fr" data-fr-theme>
    ...
    <body id="top" class="fr-mb-12w">
        <div class="fr-container fr-mt-2v fr-mb-8w">
            ...
            <a href="https://gouvfr.atlassian.net/wiki/spaces/DB/pages/217284725/Liens+-+Links" target="_blank">Documentation</a>
        </div>
        <div class="fr-mb-12w">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-637">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-637">
...
&lt;/a&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-638">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-638">
                                    <pre class=" language-html"><code>&lt;a class="fr-link fr-fi-arrow-left-line fr-link--icon-left" href="#"&gt;
    Label lien
&lt;/a&gt;
</code></pre>
                                </div>
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-639">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-639">
                                    <pre class=" language-html"><code>&lt;a class="fr-link fr-fi-arrow-right-line fr-link--icon-right" href="#"&gt;
    Label lien
&lt;/a&gt;
</code></pre>
                                </div>
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-640">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-640">
...
&lt;/a&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-641">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-641">
...
&lt;/a&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-642">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-642">
...
&lt;/a&gt;
                        ...
                        <h4>Lien Haut de page - id=&#34;top&#34;</h4>
                        <div class="fr-mb-6v">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-643">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-643">
                                    <pre class=" language-html"><code>&lt;a class="fr-link fr-fi-arrow-up-fill fr-link--icon-left" href="#top"&gt;
    Haut de page
&lt;/a&gt;
</code></pre>
                                </div>
