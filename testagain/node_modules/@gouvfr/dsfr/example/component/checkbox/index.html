...
<html lang="fr" data-fr-theme>
    ...
    <body id="top" class="fr-mb-12w">
        <div class="fr-container fr-mt-2v fr-mb-8w">
            ...
            <a href="https://gouvfr.atlassian.net/wiki/spaces/DB/pages/217251933/Case+cocher+-+Checkbox" target="_blank">Documentation</a>
        </div>
        <div class="fr-mb-12w">
            <div class="fr-container">
                <div class="fr-grid-row fr-grid-row--center">
                    <div class="fr-col-md-8 fr-col-12">
                        <h4>Case à cocher seule</h4>
                        <div class="fr-mb-6v">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-360">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-360">
...
&lt;/div&gt;
                        ...
                        <h4>Case à cocher seule, exemple avec indice et exposant</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-checkbox-group">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-361">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-361">
                                    <pre class=" language-html"><code>&lt;div class="fr-checkbox-group"&gt;
    &lt;input type="checkbox" id="checkbox-sup-sub" name="checkbox-sup-sub"&gt;
    &lt;label class="fr-label" for="checkbox-sup-sub"&gt;
        &lt;span&gt;Label checkbox &lt;sub&gt;sub&lt;/sub&gt; et &lt;sup&gt;sup&lt;/sup&gt;
...
&lt;/div&gt;
                        ...
                        <h4>Case à cocher avec texte d‘aide</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-checkbox-group">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-362">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-362">
                                    <pre class=" language-html"><code>&lt;div class="fr-checkbox-group"&gt;
    &lt;input type="checkbox" id="checkbox-hint" name="checkbox-hint"&gt;
    &lt;label class="fr-label" for="checkbox-hint"&gt;
        Label checkbox
...
&lt;/div&gt;
                        ...
                        <h4>Case à cocher seule, validée</h4>
                        <div class="fr-mb-6v">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-363">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-363">
...
&lt;/div&gt;
                        ...
                        <h4>Case à cocher seule avec erreur</h4>
                        <div class="fr-mb-6v">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-364">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-364">
...
&lt;/div&gt;
                        ...
                        <h4>Ensemble de cases à cocher</h4>
                        <div class="fr-mb-6v">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-365">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-365">
...
&lt;/div&gt;
                        ...
                        <h4>Ensemble de cases à cocher, petite taille</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-form-group">
                                <fieldset class="fr-fieldset">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-366">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-366">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkboxes-small-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <h4>Ensemble de cases à cocher désactivées</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-form-group">
                                <fieldset class="fr-fieldset">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-367">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-367">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkboxes-disabled-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <h4>Ensemble de cases à cocher en ligne</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-form-group">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-368">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-368">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset fr-fieldset--inline"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkboxes-inline-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <h4>Ensemble de cases à cocher avec texte d‘aide</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-form-group">
                                <fieldset class="fr-fieldset">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-369">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-369">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkboxes-hint-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <h4>Ensemble de cases à cocher avec erreur</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-form-group">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-370">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-370">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset fr-fieldset--error" aria-labelledby="checkboxes-error-legend checkboxes-error-desc-error" role="group"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkboxes-error-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <h4>Ensemble de cases à cocher validées</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-form-group">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-371">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-371">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset fr-fieldset--valid" aria-labelledby="checkboxes-valid-legend checkboxes-valid-desc-valid" role="group"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkboxes-valid-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <h4>Ensemble de cases à cocher avec erreur, en ligne</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-form-group">
...
&lt;/div&gt;
                        ...
                        <h4>Ensemble de cases à cocher validées, en ligne</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-form-group">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-373">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-373">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset fr-fieldset--inline fr-fieldset--valid" aria-labelledby="checkboxes-valid-inline-legend checkboxes-valid-inline-desc-valid" role="group"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkboxes-valid-inline-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <h4>Ensemble de cases à cocher avec texte d‘aide spécifique</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-form-group">
                                <fieldset class="fr-fieldset">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-374">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-374">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkboxes-hint-element-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <h4>Ensemble de cases à cocher avec texte d‘aide spécifique, petite taille</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-form-group">
                                <fieldset class="fr-fieldset">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-375">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-375">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='checkboxes-hint-el-sm-legend'&gt;
            Légende pour l’ensemble de champs
