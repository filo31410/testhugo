...
<html lang="fr" data-fr-theme>
    ...
    <body id="top" class="fr-mb-12w">
        <div class="fr-container fr-mt-2v fr-mb-8w">
            ...
            <a href="https://gouvfr.atlassian.net/wiki/spaces/DB/pages/771358744/" target="_blank">Documentation</a>
        </div>
        <div class="fr-mb-12w">
            <div class="fr-container">
                <div class="fr-grid-row fr-grid-row--center">
                    <div class="fr-col-md-8 fr-col-12">
                        <h4>Citation par défaut (texte taille xl)</h4>
                        <div class="fr-mb-6v">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-398">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-398">
...
&lt;/figure&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-399">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-399">
                                    <pre class=" language-html"><code>&lt;figure class="fr-quote"&gt;
    &lt;blockquote cite="[À MODIFIER - https://lien-vers-la-source.fr]"&gt;
...
&lt;/figure&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-400">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-400">
...
&lt;/figure&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-401">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-401">
