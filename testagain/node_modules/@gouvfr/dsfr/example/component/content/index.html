...
<html lang="fr" data-fr-theme>
    ...
    <body id="top" class="fr-mb-12w">
        <div class="fr-container fr-mt-2v fr-mb-8w">
            ...
            <a href="https://gouvfr.atlassian.net/wiki/spaces/DB/pages/223019554/M+dias+int+gr+s+au+contenu+-+Responsive+medias" target="_blank">Documentation</a>
        </div>
        <div class="fr-mb-12w">
            <div class="fr-container">
                <div class="fr-grid-row fr-grid-row--center">
                    <div class="fr-col-md-8 fr-col-12">
                        <h4>Média image edito</h4>
                        <div class="fr-mb-6v">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-402">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-402">
...
&lt;/figure&gt;
                        ...
                        <h4>Média image edito, petite taille</h4>
                        <div class="fr-mb-6v">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-403">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-403">
                                    <pre class=" language-html"><code>&lt;figure class="fr-content-media fr-content-media--sm" role="group" aria-label="© Légende de l‘image"&gt;
    &lt;div class="fr-content-media__img"&gt;
        &lt;img class="fr-responsive-img" src="../../../example/img/placeholder.16x9.png" alt="[À MODIFIER - vide ou texte alternatif de l’image]" /&gt;
        &lt;!-- L’alternative de l’image (attribut alt) doit toujours être présente, sa valeur peut-être vide (image n’apportant pas de sens supplémentaire au contexte) ou non (porteuse de texte ou apportant du sens) selon votre contexte --&gt;
    &lt;/div&gt;
...
&lt;/figure&gt;
                        ...
                        <h4>Média image edito, grande taille</h4>
                        <div class="fr-mb-6v">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-404">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-404">
                                    <pre class=" language-html"><code>&lt;figure class="fr-content-media fr-content-media--lg" role="group" aria-label="© Légende de l‘image"&gt;
    &lt;div class="fr-content-media__img"&gt;
        &lt;img class="fr-responsive-img" src="../../../example/img/placeholder.16x9.png" alt="[À MODIFIER - vide ou texte alternatif de l’image]" /&gt;
        &lt;!-- L’alternative de l’image (attribut alt) doit toujours être présente, sa valeur peut-être vide (image n’apportant pas de sens supplémentaire au contexte) ou non (porteuse de texte ou apportant du sens) selon votre contexte --&gt;
    &lt;/div&gt;
...
&lt;/figure&gt;
                        ...
                        <h4>Média image en svg, porteur d’information</h4>
                        <div class="fr-mb-6v">
                            <figure class="fr-content-media" role="group" aria-label="© Légende de l‘image">
                                <div class="fr-content-media__img">
                                    ...
                                    <svg version="1.1" role="img" aria-label=”Gouvernement” xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 895 455" style="background:#ffffff" xml:space="preserve">
                                        <style type="text/css">
                                            .st0 {
                                                fill: #1F356C;
                                            }
			...
			c3-8.1,4.2-8.8,11.5-10.1L44.5,272.3z" />
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-405">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-405">
                                    <pre class=" language-html"><code>&lt;figure class="fr-content-media" role="group" aria-label="© Légende de l‘image"&gt;
    &lt;div class="fr-content-media__img"&gt;
        &lt;!-- Les SVG porteurs de sens doivent avoir l'attribut role="img" et être labeliser par l'attribut aria-label="[A modifier - titre ou texte contenu dans l’image]" --&gt;
        &lt;svg version="1.1" role="img" aria-label=”Gouvernement” xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 895 455" style="background:#ffffff" xml:space="preserve"&gt;
...
&lt;/figure&gt;
                        ...
                        <h4>Média image, SVG décoratif</h4>
                        <div class="fr-mb-6v">
                            <figure class="fr-content-media" role="group" aria-label="© Légende de l‘image">
                                <div class="fr-content-media__img">
                                    <!-- Les SVG illustratifs (non porteur de sens) doivent avoir l'attribut aria-hidden="true" -->
                                    <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="360" height="360" viewBox="0 0 360 360">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-406">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-406">
                                    <pre class=" language-html"><code>&lt;figure class="fr-content-media" role="group" aria-label="© Légende de l‘image"&gt;
    &lt;div class="fr-content-media__img"&gt;
        &lt;!-- Les SVG illustratifs (non porteur de sens) doivent avoir l'attribut aria-hidden="true" --&gt;
        &lt;svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="360" height="360" viewBox="0 0 360 360"&gt;
...
&lt;/figure&gt;
                        ...
                        <h4>Média video edito, ratio d‘aspect 16/9 par défaut</h4>
                        <div class="fr-mb-6v">
...
&lt;/div&gt;
                        ...
                        <h4>Média video edito, ratio d‘aspect 16/9 par défaut, petite taille</h4>
                        <div class="fr-mb-6v">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-408">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-408">
                                    <pre class=" language-html"><code>&lt;div class="fr-content-media fr-content-media--sm"&gt;
    &lt;div class="fr-responsive-vid"&gt;
        &lt;iframe title="titre de l’iframe" class="fr-responsive-vid__player" src="https://www.youtube.com/embed/HyirpmPL43I" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen&gt;&lt;/iframe&gt;
    &lt;/div&gt;
    &lt;div class="fr-content-media__caption"&gt;© Légende de la vidéo&lt;/div&gt;
...
&lt;/div&gt;
                        ...
                        <h4>Média video edito, ratio d‘aspect 16/9 par défaut, grande taille</h4>
                        <div class="fr-mb-6v">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-409">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-409">
                                    <pre class=" language-html"><code>&lt;div class="fr-content-media fr-content-media--lg"&gt;
    &lt;div class="fr-responsive-vid"&gt;
        &lt;iframe title="titre de l’iframe" class="fr-responsive-vid__player" src="https://www.youtube.com/embed/HyirpmPL43I" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen&gt;&lt;/iframe&gt;
    &lt;/div&gt;
    &lt;div class="fr-content-media__caption"&gt;© Légende de la vidéo&lt;/div&gt;
...
&lt;/div&gt;
                        ...
                        <h4>Média video edito, ratio d‘aspect 4x3</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-content-media">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-410">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-410">
                                    <pre class=" language-html"><code>&lt;div class="fr-content-media"&gt;
    &lt;div class="fr-responsive-vid fr-responsive-vid--4x3"&gt;
        &lt;iframe title="titre de l’iframe" class="fr-responsive-vid__player" src="https://www.youtube.com/embed/HyirpmPL43I" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen&gt;&lt;/iframe&gt;
    &lt;/div&gt;
...
&lt;/div&gt;
                        ...
                        <h4>Média video edito, ratio d‘aspect 4x3, petite taille</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-content-media fr-content-media--sm">
                                <div class="fr-responsive-vid fr-responsive-vid--4x3">
                                    <iframe title="titre de l’iframe" class="fr-responsive-vid__player" src="https://www.youtube.com/embed/HyirpmPL43I" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-411">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-411">
                                    <pre class=" language-html"><code>&lt;div class="fr-content-media fr-content-media--sm"&gt;
    &lt;div class="fr-responsive-vid fr-responsive-vid--4x3"&gt;
        &lt;iframe title="titre de l’iframe" class="fr-responsive-vid__player" src="https://www.youtube.com/embed/HyirpmPL43I" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen&gt;&lt;/iframe&gt;
    &lt;/div&gt;
...
&lt;/div&gt;
                        ...
                        <h4>Média video edito, ratio d‘aspect 4x3, grande taille</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-content-media fr-content-media--lg">
                                <div class="fr-responsive-vid fr-responsive-vid--4x3">
                                    <iframe title="titre de l’iframe" class="fr-responsive-vid__player" src="https://www.youtube.com/embed/HyirpmPL43I" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-412">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-412">
                                    <pre class=" language-html"><code>&lt;div class="fr-content-media fr-content-media--lg"&gt;
    &lt;div class="fr-responsive-vid fr-responsive-vid--4x3"&gt;
        &lt;iframe title="titre de l’iframe" class="fr-responsive-vid__player" src="https://www.youtube.com/embed/HyirpmPL43I" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen&gt;&lt;/iframe&gt;
    &lt;/div&gt;
...
&lt;/div&gt;
                        ...
                        <h4>Média video edito, ratio d‘aspect 1x1</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-content-media">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-413">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-413">
                                    <pre class=" language-html"><code>&lt;div class="fr-content-media"&gt;
    &lt;div class="fr-responsive-vid fr-responsive-vid--1x1"&gt;
        &lt;iframe title="titre de l’iframe" class="fr-responsive-vid__player" src="https://www.youtube.com/embed/HyirpmPL43I" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen&gt;&lt;/iframe&gt;
    &lt;/div&gt;
...
&lt;/div&gt;
                        ...
                        <h4>Média video edito, ratio d‘aspect 1x1, petite taille</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-content-media fr-content-media--sm">
                                <div class="fr-responsive-vid fr-responsive-vid--1x1">
                                    <iframe title="titre de l’iframe" class="fr-responsive-vid__player" src="https://www.youtube.com/embed/HyirpmPL43I" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-414">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-414">
                                    <pre class=" language-html"><code>&lt;div class="fr-content-media fr-content-media--sm"&gt;
    &lt;div class="fr-responsive-vid fr-responsive-vid--1x1"&gt;
        &lt;iframe title="titre de l’iframe" class="fr-responsive-vid__player" src="https://www.youtube.com/embed/HyirpmPL43I" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen&gt;&lt;/iframe&gt;
    &lt;/div&gt;
...
&lt;/div&gt;
                        ...
                        <h4>Média video edito, ratio d‘aspect 1x1, grande taille</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-content-media fr-content-media--lg">
                                <div class="fr-responsive-vid fr-responsive-vid--1x1">
                                    <iframe title="titre de l’iframe" class="fr-responsive-vid__player" src="https://www.youtube.com/embed/HyirpmPL43I" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-415">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-415">
                                    <pre class=" language-html"><code>&lt;div class="fr-content-media fr-content-media--lg"&gt;
    &lt;div class="fr-responsive-vid fr-responsive-vid--1x1"&gt;
        &lt;iframe title="titre de l’iframe" class="fr-responsive-vid__player" src="https://www.youtube.com/embed/HyirpmPL43I" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen&gt;&lt;/iframe&gt;
    &lt;/div&gt;
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-416">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-416">
                                    <pre class=" language-html"><code>&lt;div class="fr-content-media"&gt;
    &lt;div class="fr-responsive-vid"&gt;
        &lt;iframe title="titre de l’iframe" class="fr-responsive-vid__player" src="https://www.youtube.com/embed/HyirpmPL43I" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen&gt;&lt;/iframe&gt;
    &lt;/div&gt;
