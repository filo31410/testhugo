...
<html lang="fr" data-fr-theme>
    ...
    <body id="top" class="fr-mb-12w">
        <div class="fr-container fr-mt-2v fr-mb-8w">
            ...
            <a href="https://gouvfr.atlassian.net/wiki/spaces/DB/pages/779747332" target="_blank">Documentation</a>
        </div>
        <div class="fr-mb-12w">
            <h4>Réseaux sociaux seuls</h4>
            <div class="fr-mb-6v">
                <div class="fr-follow">
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-629">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-629">
...
&lt;/div&gt;
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-630">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-630">
                        <pre class=" language-html"><code>&lt;div class="fr-follow"&gt;
    &lt;div class="fr-container"&gt;
        &lt;div class="fr-grid-row"&gt;
            &lt;div class="fr-col-12"&gt;
...
&lt;/div&gt;
            ...
            <h4>Lettre d&#39;info seule avec formulaire</h4>
            <div class="fr-mb-6v">
                <div class="fr-follow">
                    <div class="fr-container">
                        <div class="fr-grid-row">
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-631">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-631">
                        <pre class=" language-html"><code>&lt;div class="fr-follow"&gt;
    &lt;div class="fr-container"&gt;
        &lt;div class="fr-grid-row"&gt;
            &lt;div class="fr-col-12"&gt;
...
&lt;/div&gt;
            ...
            <h4>Réseaux sociaux et Lettre d&#39;info mise en avant</h4>
            <div class="fr-mb-6v">
                <div class="fr-follow">
                    <div class="fr-container">
                        <div class="fr-grid-row">
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-632">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-632">
                        <pre class=" language-html"><code>&lt;div class="fr-follow"&gt;
    &lt;div class="fr-container"&gt;
        &lt;div class="fr-grid-row"&gt;
            &lt;div class="fr-col-12 fr-col-md-8"&gt;
...
&lt;/div&gt;
            ...
            <h4>Réseaux sociaux et Lettre d&#39;info avec formulaire</h4>
            <div class="fr-mb-6v">
                <div class="fr-follow">
                    <div class="fr-container">
                        <div class="fr-grid-row">
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-633">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-633">
                        <pre class=" language-html"><code>&lt;div class="fr-follow"&gt;
    &lt;div class="fr-container"&gt;
        &lt;div class="fr-grid-row"&gt;
            &lt;div class="fr-col-12 fr-col-md-8"&gt;
...
&lt;/div&gt;
            ...
            <h4>Réseaux sociaux et Lettre d&#39;info avec formulaire - erreur</h4>
            <div class="fr-mb-6v">
                <div class="fr-follow">
                    <div class="fr-container">
                        <div class="fr-grid-row">
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-634">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-634">
                        <pre class=" language-html"><code>&lt;div class="fr-follow"&gt;
    &lt;div class="fr-container"&gt;
        &lt;div class="fr-grid-row"&gt;
            &lt;div class="fr-col-12 fr-col-md-8"&gt;
...
&lt;/div&gt;
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-635">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-635">
                        <pre class=" language-html"><code>&lt;div class="fr-follow"&gt;
    &lt;div class="fr-container"&gt;
        &lt;div class="fr-grid-row"&gt;
            &lt;div class="fr-col-12"&gt;
...
&lt;/div&gt;
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-636">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-636">
                        <pre class=" language-html"><code>&lt;div class="fr-follow"&gt;
    &lt;div class="fr-container"&gt;
        &lt;div class="fr-grid-row"&gt;
            &lt;div class="fr-col-12 fr-col-md-8"&gt;
