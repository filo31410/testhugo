...
<html lang="fr" data-fr-theme>
    ...
    <body id="top" class="fr-mb-12w">
        <div class="fr-container fr-mt-2v fr-mb-8w">
            ...
            <a href="https://gouvfr.atlassian.net/wiki/spaces/DB/pages/609189956/" target="_blank">Documentation</a>
        </div>
        <div class="fr-mb-12w">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-566">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-566">
...
&lt;/div&gt;
                        ...
                        <h4>Panneau de gestion des cookies</h4>
                        <div class="fr-mb-6v">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-567">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-567">
...
&lt;/dialog&gt;
                        ...
                        <h4>Placeholder cookies désactivés standard</h4>
                        <div class="fr-mb-6v">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-568">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-568">
...
&lt;/div&gt;
                        ...
                        <h4>Placeholder dans un bloc vidéo responsive grande taille</h4>
                        <div class="fr-mb-6v">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-569">Extrait de code</button>
                                </h3>
