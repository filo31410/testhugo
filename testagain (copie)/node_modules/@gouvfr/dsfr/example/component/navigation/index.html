...
<html lang="fr" data-fr-theme>
    ...
    <head>
        ...
        <title>Navigation principale - Design System</title>
    ...
    <body id="top" class="fr-mb-12w">
        <div class="fr-container fr-mt-2v fr-mb-8w">
            ...
            <a href="https://gouvfr.atlassian.net/wiki/spaces/DB/pages/222789853/Navigation+principale+-+Main+navigation" target="_blank">Documentation</a>
        </div>
        <div class="fr-mb-12w">
            ...
            <div class="fr-mb-6v">
                <div style="position:relative">
                    <div class="fr-container">
                        <nav class="fr-nav" id="navigation-928" role="navigation" aria-label="Menu principal">
                            <ul class="fr-nav__list">
                                <li class="fr-nav__item">
                                    <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-929">Entrée menu</button>
                                    <div class="fr-collapse fr-menu" id="menu-929">
                                ...
                                <li class="fr-nav__item">
                                    <button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-930">Entrée mega menu</button>
                                    <div class="fr-collapse fr-mega-menu" id="mega-menu-930">
                                        <div class="fr-container fr-container--fluid fr-container-lg">
                                            <div class="fr-grid-row fr-grid-row-lg--gutters">
                                                <div class="fr-col-12 fr-mb-n3v">
                                                    <button class="fr-btn--close fr-btn" aria-controls="mega-menu-930" title="Fermer">
                                                        Fermer
                                                    </button>
                                                </div>
                                ...
                                <li class="fr-nav__item">
                                    <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-931" aria-current="true">Entrée menu active</button>
                                    <div class="fr-collapse fr-menu" id="menu-931">
                                        <ul class="fr-menu__list">
                                            <li>
                                                <a class="fr-nav__link" href="#" target="_self">Lien de navigation</a>
                                            </li>
                                ...
                                <li class="fr-nav__item">
                                    <button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-932">Entrée mega menu</button>
                                    <div class="fr-collapse fr-mega-menu" id="mega-menu-932">
                                        <div class="fr-container fr-container--fluid fr-container-lg">
                                            <div class="fr-grid-row fr-grid-row-lg--gutters">
                                                <div class="fr-col-12 fr-mb-n3v">
                                                    <button class="fr-btn--close fr-btn" aria-controls="mega-menu-932" title="Fermer">
                                                        Fermer
                                                    </button>
                                                </div>
                                                <div class="fr-col-12 fr-col-lg-8 fr-col-offset-lg-4--right fr-mb-4v">
                                ...
                                <li class="fr-nav__item">
                                    <button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-933">Entrée mega menu</button>
                                    <div class="fr-collapse fr-mega-menu" id="mega-menu-933">
                                        <div class="fr-container fr-container--fluid fr-container-lg">
                                            <div class="fr-grid-row fr-grid-row-lg--gutters">
                                                <div class="fr-col-12 fr-mb-n3v">
                                                    <button class="fr-btn--close fr-btn" aria-controls="mega-menu-933" title="Fermer">
                                                        Fermer
                                                    </button>
                                                </div>
                                                <div class="fr-col-12 fr-col-lg-3">
                                ...
                                <li class="fr-nav__item">
                                    <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-934">Entrée menu</button>
                                    <div class="fr-collapse fr-menu" id="menu-934">
                                        <ul class="fr-menu__list">
                                            <li>
                                                <a class="fr-nav__link" href="#" target="_self">Lien de navigation</a>
                                            </li>
                ...
                <div class="fr-container">
                    <section class="fr-accordion">
                        ...
                        <div class="fr-collapse" id="snippet-942">
                            <pre class=" language-html"><code>&lt;nav class="fr-nav" id="navigation-935" role="navigation" aria-label="Menu principal"&gt;
    &lt;ul class="fr-nav__list"&gt;
        &lt;li class="fr-nav__item"&gt;
            &lt;button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-936"&gt;Entrée menu&lt;/button&gt;
            &lt;div class="fr-collapse fr-menu" id="menu-936"&gt;
                &lt;ul class="fr-menu__list"&gt;
                    &lt;li&gt;
                        &lt;a class="fr-nav__link" href="#" target="_self"&gt;Lien de navigation&lt;/a&gt;
                    &lt;/li&gt;
        ...
        &lt;/li&gt;
        &lt;li class="fr-nav__item"&gt;
            &lt;button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-937"&gt;Entrée mega menu&lt;/button&gt;
            &lt;div class="fr-collapse fr-mega-menu" id="mega-menu-937"&gt;
                &lt;div class="fr-container fr-container--fluid fr-container-lg"&gt;
                    &lt;div class="fr-grid-row fr-grid-row-lg--gutters"&gt;
                        &lt;div class="fr-col-12 fr-mb-n3v"&gt;
                            &lt;button class="fr-btn--close fr-btn" aria-controls="mega-menu-937" title="Fermer"&gt;
                                Fermer
                            &lt;/button&gt;
                        &lt;/div&gt;
                        &lt;div class="fr-col-12 fr-col-lg-8 fr-col-offset-lg-4--right fr-mb-4v"&gt;
        ...
        &lt;/li&gt;
        &lt;li class="fr-nav__item"&gt;
            &lt;button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-938" aria-current="true"&gt;Entrée menu active&lt;/button&gt;
            &lt;div class="fr-collapse fr-menu" id="menu-938"&gt;
                &lt;ul class="fr-menu__list"&gt;
                    &lt;li&gt;
                        &lt;a class="fr-nav__link" href="#" target="_self"&gt;Lien de navigation&lt;/a&gt;
                    &lt;/li&gt;
        ...
        &lt;/li&gt;
        &lt;li class="fr-nav__item"&gt;
            &lt;button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-939"&gt;Entrée mega menu&lt;/button&gt;
            &lt;div class="fr-collapse fr-mega-menu" id="mega-menu-939"&gt;
                &lt;div class="fr-container fr-container--fluid fr-container-lg"&gt;
                    &lt;div class="fr-grid-row fr-grid-row-lg--gutters"&gt;
                        &lt;div class="fr-col-12 fr-mb-n3v"&gt;
                            &lt;button class="fr-btn--close fr-btn" aria-controls="mega-menu-939" title="Fermer"&gt;
                                Fermer
                            &lt;/button&gt;
                        &lt;/div&gt;
                        &lt;div class="fr-col-12 fr-col-lg-8 fr-col-offset-lg-4--right fr-mb-4v"&gt;
        ...
        &lt;/li&gt;
        &lt;li class="fr-nav__item"&gt;
            &lt;button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-940"&gt;Entrée mega menu&lt;/button&gt;
            &lt;div class="fr-collapse fr-mega-menu" id="mega-menu-940"&gt;
                &lt;div class="fr-container fr-container--fluid fr-container-lg"&gt;
                    &lt;div class="fr-grid-row fr-grid-row-lg--gutters"&gt;
                        &lt;div class="fr-col-12 fr-mb-n3v"&gt;
                            &lt;button class="fr-btn--close fr-btn" aria-controls="mega-menu-940" title="Fermer"&gt;
                                Fermer
                            &lt;/button&gt;
                        &lt;/div&gt;
                        &lt;div class="fr-col-12 fr-col-lg-3"&gt;
        ...
        &lt;/li&gt;
        &lt;li class="fr-nav__item"&gt;
            &lt;button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-941"&gt;Entrée menu&lt;/button&gt;
            &lt;div class="fr-collapse fr-menu" id="menu-941"&gt;
                &lt;ul class="fr-menu__list"&gt;
                    &lt;li&gt;
                        &lt;a class="fr-nav__link" href="#" target="_self"&gt;Lien de navigation&lt;/a&gt;
                    &lt;/li&gt;
