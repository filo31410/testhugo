...
<html lang="fr" data-fr-theme>
    ...
    <body id="top" class="fr-mb-12w">
        <div class="fr-container fr-mt-2v fr-mb-8w">
            ...
            <a href="https://gouvfr.atlassian.net/wiki/spaces/DB/pages/223051980/Pagination+-+Pagination" target="_blank">Documentation</a>
        </div>
        <div class="fr-mb-12w">
            <div class="fr-container">
                <h4>élément de navigation icône seule (par défaut)</h4>
                <div class="fr-mb-6v">
                ...
                <div class="fr-mb-12v">
                    <section class="fr-accordion">
                        <h3 class="fr-accordion__title">
                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1014">Extrait de code</button>
                        </h3>
...
&lt;/nav&gt;
                ...
                <h4>élément de navigation avec label</h4>
                <div class="fr-mb-6v">
                    <nav role="navigation" class="fr-pagination" aria-label="Pagination">
                        <ul class="fr-pagination__list">
                            <li>
                ...
                <div class="fr-mb-12v">
                    <section class="fr-accordion">
                        <h3 class="fr-accordion__title">
                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1015">Extrait de code</button>
                        </h3>
                        <div class="fr-collapse" id="snippet-1015">
                            <pre class=" language-html"><code>&lt;nav role="navigation" class="fr-pagination" aria-label="Pagination"&gt;
    &lt;ul class="fr-pagination__list"&gt;
        &lt;li&gt;
            &lt;a class="fr-pagination__link fr-pagination__link--prev fr-pagination__link--label" href="#"&gt;
...
&lt;/nav&gt;
                ...
                <h4>élément de navigation avec label à partir du breakpoint LG</h4>
                <div class="fr-mb-6v">
                    <nav role="navigation" class="fr-pagination" aria-label="Pagination">
                        <ul class="fr-pagination__list">
                            <li>
                ...
                <div class="fr-mb-12v">
                    <section class="fr-accordion">
                        <h3 class="fr-accordion__title">
                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1016">Extrait de code</button>
                        </h3>
                        <div class="fr-collapse" id="snippet-1016">
                            <pre class=" language-html"><code>&lt;nav role="navigation" class="fr-pagination" aria-label="Pagination"&gt;
    &lt;ul class="fr-pagination__list"&gt;
        &lt;li&gt;
            &lt;a class="fr-pagination__link fr-pagination__link--prev fr-pagination__link--lg-label" href="#"&gt;
...
&lt;/nav&gt;
                ...
                <h4>pagination première page</h4>
                <div class="fr-mb-6v">
                    <nav role="navigation" class="fr-pagination" aria-label="Pagination">
                        <ul class="fr-pagination__list">
                            <li>
                ...
                <div class="fr-mb-12v">
                    <section class="fr-accordion">
                        <h3 class="fr-accordion__title">
                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1017">Extrait de code</button>
                        </h3>
...
&lt;/nav&gt;
                ...
                <h4>pagination deuxième page</h4>
                <div class="fr-mb-6v">
                    <nav role="navigation" class="fr-pagination" aria-label="Pagination">
                        <ul class="fr-pagination__list">
                            <li>
                ...
                <div class="fr-mb-12v">
                    <section class="fr-accordion">
                        <h3 class="fr-accordion__title">
                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1018">Extrait de code</button>
                        </h3>
                        <div class="fr-collapse" id="snippet-1018">
                            <pre class=" language-html"><code>&lt;nav role="navigation" class="fr-pagination" aria-label="Pagination"&gt;
    &lt;ul class="fr-pagination__list"&gt;
        &lt;li&gt;
            &lt;a class="fr-pagination__link fr-pagination__link--first" href="#"&gt;
...
&lt;/nav&gt;
                ...
                <h4>pagination dernière page</h4>
                <div class="fr-mb-6v">
                    <nav role="navigation" class="fr-pagination" aria-label="Pagination">
                        <ul class="fr-pagination__list">
                            <li>
                ...
                <div class="fr-mb-12v">
                    <section class="fr-accordion">
                        <h3 class="fr-accordion__title">
                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1019">Extrait de code</button>
                        </h3>
                        <div class="fr-collapse" id="snippet-1019">
                            <pre class=" language-html"><code>&lt;nav role="navigation" class="fr-pagination" aria-label="Pagination"&gt;
    &lt;ul class="fr-pagination__list"&gt;
        &lt;li&gt;
            &lt;a class="fr-pagination__link fr-pagination__link--first" href="#"&gt;
