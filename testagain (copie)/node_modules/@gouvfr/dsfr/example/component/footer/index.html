...
<html lang="fr" data-fr-theme>
    ...
    <body id="top" class="fr-mb-12w">
        <div class="fr-container fr-mt-2v fr-mb-8w">
            ...
            <a href="https://gouvfr.atlassian.net/wiki/spaces/DB/pages/222331413/Pied+de+page+-+Footer" target="_blank">Documentation</a>
        </div>
        <div class="fr-mb-12w">
            <h4>Pied de page minimal</h4>
            <div class="fr-mb-6v">
                <footer class="fr-footer" role="contentinfo" id="footer-1047">
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1049">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-1049">
                        <pre class=" language-html"><code>&lt;footer class="fr-footer" role="contentinfo" id="footer-1048"&gt;
    &lt;div class="fr-container"&gt;
        &lt;div class="fr-footer__body"&gt;
            &lt;div class="fr-footer__brand fr-enlarge-link"&gt;
                &lt;a href="/" title="Retour à l’accueil"&gt;
...
&lt;/footer&gt;
            ...
            <h4>Pied de page avec navigation</h4>
            <div class="fr-mb-6v">
                <footer class="fr-footer" role="contentinfo" id="footer-1050">
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    ...
                    <div class="fr-collapse" id="snippet-1052">
                        <pre class=" language-html"><code>&lt;footer class="fr-footer" role="contentinfo" id="footer-1051"&gt;
    &lt;div class="fr-footer__top"&gt;
        &lt;div class="fr-container"&gt;
            &lt;div class="fr-grid-row fr-grid-row--start fr-grid-row--gutters"&gt;
                &lt;div class="fr-col-12 fr-col-sm-3 fr-col-md-2"&gt;
...
&lt;/footer&gt;
            ...
            <h4>Pied de page avec logo opérateur</h4>
            <div class="fr-mb-6v">
                <footer class="fr-footer" role="contentinfo" id="footer-1053">
                    <div class="fr-container">
                        <div class="fr-footer__body">
                            <div class="fr-footer__brand fr-enlarge-link">
                                <p class="fr-logo">
                                ...
                                <a class="fr-footer__brand-link" href="/" title="Retour à l’accueil">
                                    <img class="fr-footer__logo fr-responsive-img" style="max-width:12.5rem" src="../../../example/img/placeholder.16x9.png" alt="[À MODIFIER - texte alternatif de l’image]" />
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1055">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-1055">
                        <pre class=" language-html"><code>&lt;footer class="fr-footer" role="contentinfo" id="footer-1054"&gt;
    &lt;div class="fr-container"&gt;
        &lt;div class="fr-footer__body"&gt;
            &lt;div class="fr-footer__brand fr-enlarge-link"&gt;
                &lt;p class="fr-logo"&gt;
...
&lt;/footer&gt;
            ...
            <h4>Pied de page avec logos partenaires</h4>
            <div class="fr-mb-6v">
                <footer class="fr-footer" role="contentinfo" id="footer-1056">
                    <div class="fr-container">
                        <div class="fr-footer__body">
                            <div class="fr-footer__brand fr-enlarge-link">
                                <a href="/" title="Retour à l’accueil">
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1058">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-1058">
                        <pre class=" language-html"><code>&lt;footer class="fr-footer" role="contentinfo" id="footer-1057"&gt;
    &lt;div class="fr-container"&gt;
        &lt;div class="fr-footer__body"&gt;
            &lt;div class="fr-footer__brand fr-enlarge-link"&gt;
                &lt;a href="/" title="Retour à l’accueil"&gt;
...
&lt;/footer&gt;
            ...
            <h4>Pied de page complet</h4>
            <div class="fr-mb-6v">
                <footer class="fr-footer" role="contentinfo" id="footer-1059">
                    <div class="fr-footer__top">
                        <div class="fr-container">
                            <div class="fr-grid-row fr-grid-row--start fr-grid-row--gutters">
                                <div class="fr-col-12 fr-col-sm-3 fr-col-md-2">
            ...
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1061">Extrait de code</button>
                    </h3>
                    <div class="fr-collapse" id="snippet-1061">
                        <pre class=" language-html"><code>&lt;footer class="fr-footer" role="contentinfo" id="footer-1060"&gt;
    &lt;div class="fr-footer__top"&gt;
        &lt;div class="fr-container"&gt;
            &lt;div class="fr-grid-row fr-grid-row--start fr-grid-row--gutters"&gt;
                &lt;div class="fr-col-12 fr-col-sm-3 fr-col-md-2"&gt;
