...
<html lang="fr" data-fr-theme>
    ...
    <body id="top" class="fr-mb-12w">
        <div class="fr-container fr-mt-2v fr-mb-8w">
            ...
            <ul>
                <li>
                    <a href="https://gouvfr.atlassian.net/wiki/spaces/DB/pages/217088553/Boutons+radio+-+Radio+button" target="_blank">Bouton radio</a>
                </li>
                <li>
                    <a href="https://gouvfr.atlassian.net/wiki/spaces/DB/pages/368935129/Bouton+radio+riche+-+radio+button+extended" target="_blank">Bouton radio riche</a>
                </li>
            </ul>
        </div>
        <div class="fr-mb-12w">
            <div class="fr-container">
                <div class="fr-grid-row fr-grid-row--center">
                    <div class="fr-col-md-8 fr-col-12">
                        <div class="fr-mt-32v">
                            <h3>Bouton radio simple</h3>
                        </div>
                        <h4>Ensemble de boutons radio</h4>
                        <div class="fr-mb-6v">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-337">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-337">
...
&lt;/div&gt;
                        ...
                        <h4>Ensemble de boutons radio, petite taille</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-form-group">
                                <fieldset class="fr-fieldset">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-338">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-338">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='radio-small-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <h4>Ensemble de boutons radio désactivées</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-form-group">
                                <fieldset class="fr-fieldset">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-339">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-339">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='radio-disabled-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <h4>Ensemble de boutons radio en ligne</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-form-group">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-340">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-340">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset fr-fieldset--inline"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='radio-inline-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <h4>Ensemble de boutons radio avec texte d‘aide</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-form-group">
                                <fieldset class="fr-fieldset">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-341">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-341">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='radio-hint-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <h4>Ensemble de boutons radio avec erreur</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-form-group">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-342">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-342">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset fr-fieldset--error" aria-labelledby="radio-error-legend radio-error-desc-error" role="group"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='radio-error-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <h4>Ensemble de boutons radio avec erreur, en ligne</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-form-group">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-343">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-343">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset fr-fieldset--inline fr-fieldset--error" aria-labelledby="radio-error-inline-legend radio-error-inline-desc-error" role="group"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='radio-error-inline-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <h4>Ensemble de boutons radio validés</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-form-group">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-344">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-344">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset fr-fieldset--valid" aria-labelledby="radio-valid-legend radio-valid-desc-valid" role="group"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='radio-valid-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <h4>Ensemble de boutons radio validés, en ligne</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-form-group">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-345">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-345">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset fr-fieldset--inline fr-fieldset--valid" aria-labelledby="radio-valid-inline-legend radio-valid-inline-desc-valid" role="group"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='radio-valid-inline-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <h4>Ensemble de boutons radio avec texte d‘aide spécifique</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-form-group">
                                <fieldset class="fr-fieldset">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-346">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-346">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='radio-hint-element-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <h4>Ensemble de boutons radio avec texte d‘aide spécifique, petite taille</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-form-group">
                                <fieldset class="fr-fieldset">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-347">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-347">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='radio-hint-el-sm-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <h4>Ensemble de boutons radio, libellé en indice et exposant</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-form-group">
                                <fieldset class="fr-fieldset">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-348">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-348">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='radio-sub-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <div class="fr-mt-32v">
                            <h3>Bouton radio riche</h3>
                        </div>
                        <h4>Ensemble de boutons radio riches, simple</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-form-group">
                                <fieldset class="fr-fieldset">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-349">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-349">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='radio-rich-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <h4>Ensemble de boutons radio riches, en ligne, simple</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-form-group">
                                <fieldset class="fr-fieldset fr-fieldset--inline">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-350">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-350">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset fr-fieldset--inline"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='radio-rich-inline-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <h4>Ensemble de boutons radio riches avec textes d&#39;aide</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-form-group">
                                <fieldset class="fr-fieldset">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-351">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-351">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='radio-rich-hint-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <h4>Ensemble de boutons radio riches avec textes d&#39;aide, en ligne</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-form-group">
                                <fieldset class="fr-fieldset fr-fieldset--inline">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-352">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-352">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset fr-fieldset--inline"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='radio-rich-hint-inline-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <h4>Ensemble de boutons radio riches avec erreur et textes d&#39;aide</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-form-group">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-353">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-353">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset fr-fieldset--error" aria-labelledby="radio-rich-error-legend radio-rich-error-desc-error" role="group"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='radio-rich-error-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <h4>Ensemble de boutons radio riches avec erreur et textes d&#39;aide, en ligne</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-form-group">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-354">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-354">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset fr-fieldset--inline fr-fieldset--error" aria-labelledby="radio-rich-error-inline-legend radio-rich-error-inline-desc-error" role="group"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='radio-rich-error-inline-legend'&gt;
            Légende pour l’ensemble de champs
...
&lt;/div&gt;
                        ...
                        <h4>Ensemble de boutons radio riches désactivés</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-form-group">
                                <fieldset class="fr-fieldset">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-355">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-355">
                                    <pre class=" language-html"><code>&lt;div class="fr-form-group"&gt;
    &lt;fieldset class="fr-fieldset"&gt;
        &lt;legend class="fr-fieldset__legend fr-text--regular" id='radio-rich-disabled-legend'&gt;
            Légende pour l’ensemble de champs
