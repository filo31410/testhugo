...
<html lang="fr" data-fr-theme>
    ...
    <body id="top" class="fr-mb-12w">
        <div class="fr-container fr-mt-2v fr-mb-8w">
            ...
            <a href="https://gouvfr.atlassian.net/wiki/spaces/DB/pages/771555355/" target="_blank">Documentation</a>
        </div>
        <div class="fr-mb-12w">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1042">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-1042">
...
&lt;meta name="twitter:image:alt" content="[À MODIFIER - République Française - Système de Design de l&amp;#39;État]"&gt;
                        ...
                        <h4>Boutons de partage par défaut</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-share">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1043">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-1043">
...
&lt;/div&gt;
                        ...
                        <h4>Boutons de partage version inactive</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-share">
                                <p class="fr-share__title">Partager la page</p>
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1044">Extrait de code</button>
                                </h3>
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1045">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-1045">
                                    <pre class=" language-html"><code>&lt;div class="fr-share"&gt;
    &lt;p class="fr-share__title"&gt;Partager la page&lt;/p&gt;
    &lt;ul class="fr-share__group"&gt;
        &lt;li&gt;
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1046">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-1046">
                                    <pre class=" language-html"><code>&lt;div class="fr-share"&gt;
    &lt;p class="fr-share__title"&gt;Partager la page&lt;/p&gt;
    &lt;p class="fr-share__text"&gt;Veuillez &lt;a href=[À MODIFIER - url page autorisation cookies]&gt;autoriser le dépôt de cookies&lt;/a&gt; pour partager sur Facebook, Twitter et LinkedIn.&lt;/p&gt;
    &lt;ul class="fr-share__group"&gt;
