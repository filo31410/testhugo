...
<html lang="fr" data-fr-theme>
    ...
    <body id="top" class="fr-mb-12w">
        <div class="fr-container fr-mt-2v fr-mb-8w">
            ...
            <a href="https://gouvfr.atlassian.net/wiki/spaces/DB/pages/217186376/Barre+de+recherche+-+Search+bar" target="_blank">Documentation</a>
        </div>
        <div class="fr-mb-12w">
            <div class="fr-container">
                <div class="fr-grid-row fr-grid-row--center">
                    <div class="fr-col-md-8 fr-col-12">
                        <h4>Barre de recherche MD (par défaut)</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-search-bar" id="search-278" role="search">
                                <label class="fr-label" for="search-278-input">
                                    Rechercher
                                </label>
                                <input class="fr-input" placeholder="Rechercher" type="search" id="search-278-input" name="search-278-input">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-280">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-280">
                                    <pre class=" language-html"><code>&lt;div class="fr-search-bar" id="search-279" role="search"&gt;
    &lt;label class="fr-label" for="search-279-input"&gt;
        Rechercher
    &lt;/label&gt;
    &lt;input class="fr-input" placeholder="Rechercher" type="search" id="search-279-input" name="search-279-input"&gt;
    &lt;button class="fr-btn" title="Rechercher"&gt;
        Rechercher
    &lt;/button&gt;
&lt;/div&gt;
                        ...
                        <h4>Barre de recherche LG</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-search-bar fr-search-bar--lg" id="search-281" role="search">
                                <label class="fr-label" for="search-281-input">
                                    Rechercher
                                </label>
                                <input class="fr-input" placeholder="Rechercher" type="search" id="search-281-input" name="search-281-input">
                                <button class="fr-btn">
                                    Rechercher
                                </button>
                            </div>
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-283">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-283">
                                    <pre class=" language-html"><code>&lt;div class="fr-search-bar fr-search-bar--lg" id="search-282" role="search"&gt;
    &lt;label class="fr-label" for="search-282-input"&gt;
        Rechercher
    &lt;/label&gt;
    &lt;input class="fr-input" placeholder="Rechercher" type="search" id="search-282-input" name="search-282-input"&gt;
    &lt;button class="fr-btn"&gt;
        Rechercher
    &lt;/button&gt;
&lt;/div&gt;
