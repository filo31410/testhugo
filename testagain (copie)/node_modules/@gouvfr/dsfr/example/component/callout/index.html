...
<html lang="fr" data-fr-theme>
    ...
    <body id="top" class="fr-mb-12w">
        <div class="fr-container fr-mt-2v fr-mb-8w">
            ...
            <a href="https://gouvfr.atlassian.net/wiki/spaces/DB/pages/222331196/Mise+en+avant+-+Call-out" target="_blank">Documentation</a>
        </div>
        <div class="fr-mb-12w">
            <div class="fr-container">
                <div class="fr-grid-row fr-grid-row--center">
                    <div class="fr-col-md-8 fr-col-12">
                        <h4>Mise en avant avec texte seul</h4>
                        <div class="fr-mb-6v">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                ...
                                <div class="fr-collapse" id="snippet-895">
                                    <pre class=" language-html"><code>&lt;div class="fr-callout"&gt;
    &lt;p class="fr-callout__text"&gt;Les parents d’enfants de 11 à 14 ans n’ont aucune démarche à accomplir : les CAF versent automatiquement l’ARS aux familles déjà allocataires qui remplissent les conditions.&lt;/p&gt;
&lt;/div&gt;
</code></pre>
                                </div>
                        ...
                        <h4>Mise en avant avec titre et texte</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-callout">
...
&lt;/div&gt;
                        ...
                        <h4>Mise en avant avec titre, bouton et texte</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-callout">
                                <h4 class="fr-callout__title">Titre mise en avant</h4>
                                <p class="fr-callout__text">Les parents d’enfants de 11 à 14 ans n’ont aucune démarche à accomplir : les CAF versent automatiquement l’ARS aux familles déjà allocataires qui remplissent les conditions.</p>
...
&lt;/div&gt;
                        ...
                        <h4>Mise en avant avec titre, bouton, icône et texte</h4>
                        <div class="fr-mb-6v">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                ...
                                <div class="fr-collapse" id="snippet-898">
                                    <pre class=" language-html"><code>&lt;div class="fr-callout fr-icon-info-line"&gt;
    &lt;h4 class="fr-callout__title"&gt;Titre mise en avant&lt;/h4&gt;
    &lt;p class="fr-callout__text"&gt;Les parents d’enfants de 11 à 14 ans n’ont aucune démarche à accomplir : les CAF versent automatiquement l’ARS aux familles déjà allocataires qui remplissent les conditions.&lt;/p&gt;
    &lt;button class="fr-btn"&gt;
        Label bouton
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                ...
                                <div class="fr-collapse" id="snippet-899">
                                    <pre class=" language-html"><code>&lt;div class="fr-callout fr-callout--green-emeraude"&gt;
    &lt;h4 class="fr-callout__title"&gt;Titre mise en avant&lt;/h4&gt;
    &lt;p class="fr-callout__text"&gt;Les parents d’enfants de 11 à 14 ans n’ont aucune démarche à accomplir : les CAF versent automatiquement l’ARS aux familles déjà allocataires qui remplissent les conditions.&lt;/p&gt;
&lt;/div&gt;
</code></pre>
