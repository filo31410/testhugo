...
<html lang="fr" data-fr-theme>
    ...
    <body id="top" class="fr-mb-12w">
        <div class="fr-container fr-mt-2v fr-mb-8w">
            ...
            <a href="https://gouvfr.atlassian.net/wiki/spaces/DB/pages/864190467/" target="_blank">Documentation</a>
        </div>
        <div class="fr-mb-12w">
            <div class="fr-container">
                <div class="fr-grid-row fr-grid-row--center">
                    <div class="fr-col-md-8 fr-col-12">
                        <h4>Bouton upload 1 seul fichier</h4>
                        <div class="fr-mb-6v">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-218">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-218">
...
&lt;/div&gt;
                        ...
                        <h4>Bouton upload avec erreur</h4>
                        <div class="fr-mb-6v">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-219">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-219">
                                    <pre class=" language-html"><code>&lt;div class="fr-upload-group fr-input-group--error"&gt;
    &lt;label class="fr-label" for="file-upload-with-error"&gt;
        Ajouter des fichiers
        &lt;span class="fr-hint-text"&gt;Taille maximale : 500 Mo. Formats supportés : jpg, png, pdf. Plusieurs fichiers possibles. Lorem ipsum dolor sit amet, consectetur adipiscing.&lt;/span&gt;
    &lt;/label&gt;
...
&lt;/div&gt;
                        ...
                        <h4>Bouton upload fichiers multiples</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-upload-group">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-220">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-220">
                                    <pre class=" language-html"><code>&lt;div class="fr-upload-group"&gt;
    &lt;label class="fr-label" for="file-upload-multiple"&gt;
        Ajouter des fichiers
        &lt;span class="fr-hint-text"&gt;Taille maximale : 500 Mo. Formats supportés : jpg, png, pdf. Plusieurs fichiers possibles. Lorem ipsum dolor sit amet, consectetur adipiscing.&lt;/span&gt;
