...
<html lang="fr" data-fr-theme>
    ...
    <body id="top" class="fr-mb-12w">
        <div class="fr-container fr-mt-2v fr-mb-8w">
            ...
            <a href="https://gouvfr.atlassian.net/wiki/spaces/DB/pages/223019278/Fil+d+Ariane+-+Breadcrumb" target="_blank">Documentation</a>
        </div>
        <div class="fr-mb-12w">
                    ...
                    <div class="fr-col-md-8 fr-col-12">
                        ...
                        <div class="fr-mb-6v">
                            <nav role="navigation" class="fr-breadcrumb" aria-label="vous êtes ici :">
                                <button class="fr-breadcrumb__button" aria-expanded="false" aria-controls="breadcrumb-551">Voir le fil d’Ariane</button>
                                <div class="fr-collapse" id="breadcrumb-551">
                                    <ol class="fr-breadcrumb__list">
                                        ...
                                        <li>
                                            <a class="fr-breadcrumb__link" href="/segment-1/segment-2/segment-3/segment-4/segment-5/segment-6/">Segment 6</a>
                                        </li>
                                        <li>
                                            <a class="fr-breadcrumb__link" href="/segment-1/segment-2/segment-3/segment-4/segment-5/segment-6/segment-7/">Segment 7</a>
                                        </li>
                                        <li>
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-553">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-553">
                                    <pre class=" language-html"><code>&lt;nav role="navigation" class="fr-breadcrumb" aria-label="vous êtes ici :"&gt;
    &lt;button class="fr-breadcrumb__button" aria-expanded="false" aria-controls="breadcrumb-552"&gt;Voir le fil d’Ariane&lt;/button&gt;
    &lt;div class="fr-collapse" id="breadcrumb-552"&gt;
        &lt;ol class="fr-breadcrumb__list"&gt;
            &lt;li&gt;
                &lt;a class="fr-breadcrumb__link" href="/"&gt;Accueil&lt;/a&gt;
            &lt;/li&gt;
