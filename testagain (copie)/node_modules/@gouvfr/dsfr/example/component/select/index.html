...
<html lang="fr" data-fr-theme>
    ...
    <body id="top" class="fr-mb-12w">
        <div class="fr-container fr-mt-2v fr-mb-8w">
            ...
            <a href="https://gouvfr.atlassian.net/wiki/spaces/DB/pages/223019306/Liste+d+roulante+-+Select" target="_blank">Documentation</a>
        </div>
        <div class="fr-mb-12w">
            <div class="fr-container">
                <div class="fr-grid-row fr-grid-row--center">
                    <div class="fr-col-md-8 fr-col-12">
                        <h4>Liste déroulante par défaut</h4>
                        <div class="fr-mb-6v">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-656">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-656">
...
&lt;/div&gt;
                        ...
                        <h4>Liste déroulante désactivée</h4>
                        <div class="fr-mb-6v">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-657">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-657">
...
&lt;/div&gt;
                        ...
                        <h4>Liste déroulante avec texte de description</h4>
                        <div class="fr-mb-6v">
                            <div class="fr-select-group">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-658">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-658">
                                    <pre class=" language-html"><code>&lt;div class="fr-select-group"&gt;
    &lt;label class="fr-label" for="select-hint"&gt;
        Label pour liste déroulante
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-659">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-659">
...
&lt;/div&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-660">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-660">
