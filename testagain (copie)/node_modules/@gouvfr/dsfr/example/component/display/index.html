...
<html lang="fr" data-fr-theme>
    ...
    <head>
        ...
        <title>Paramètre d&#39;affichage - Design System</title>
    ...
    <body id="top" class="fr-mb-12w">
        ...
        <div class="fr-mb-12w">
            <header role="banner" class="fr-header">
                            ...
                            <div class="fr-header__brand fr-enlarge-link">
                                <div class="fr-header__brand-top">
                                    ...
                                    <div class="fr-header__navbar">
                                        <button class="fr-btn--menu fr-btn" data-fr-opened="false" aria-controls="modal-1021" aria-haspopup="menu" id="button-1022" title="Menu">
                                            Menu
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="fr-header__tools">
                                <div class="fr-header__tools-links">
                                    <ul class="fr-btns-group">
                                        <li>
                                            <button class="fr-btn--display fr-btn" aria-controls="fr-theme-modal" data-fr-opened="false" title="Paramètres d'affichage">
                ...
                <div class="fr-header__menu fr-modal" id="modal-1021" aria-labelledby="button-1022">
                    <div class="fr-container">
                        <button class="fr-btn--close fr-btn" aria-controls="modal-1021" title="Fermer">
                            Fermer
                        </button>
                        ...
                        <nav class="fr-nav" id="header-navigation" role="navigation" aria-label="Menu principal">
                            <ul class="fr-nav__list">
                                <li class="fr-nav__item">
                                    <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-1023">Entrée menu</button>
                                    <div class="fr-collapse fr-menu" id="menu-1023">
                                ...
                                <li class="fr-nav__item">
                                    <button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-1024">Entrée mega menu</button>
                                    <div class="fr-collapse fr-mega-menu" id="mega-menu-1024">
                                        <div class="fr-container fr-container--fluid fr-container-lg">
                                            <div class="fr-grid-row fr-grid-row-lg--gutters">
                                                <div class="fr-col-12 fr-mb-n3v">
                                                    <button class="fr-btn--close fr-btn" aria-controls="mega-menu-1024" title="Fermer">
                                                        Fermer
                                                    </button>
                                                </div>
                                ...
                                <li class="fr-nav__item">
                                    <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-1025" aria-current="true">Entrée menu active</button>
                                    <div class="fr-collapse fr-menu" id="menu-1025">
                                        <ul class="fr-menu__list">
                                            <li>
                                                <a class="fr-nav__link" href="#" target="_self">Lien de navigation</a>
                                            </li>
                                ...
                                <li class="fr-nav__item">
                                    <button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-1026">Entrée mega menu</button>
                                    <div class="fr-collapse fr-mega-menu" id="mega-menu-1026">
                                        <div class="fr-container fr-container--fluid fr-container-lg">
                                            <div class="fr-grid-row fr-grid-row-lg--gutters">
                                                <div class="fr-col-12 fr-mb-n3v">
                                                    <button class="fr-btn--close fr-btn" aria-controls="mega-menu-1026" title="Fermer">
                                                        Fermer
                                                    </button>
                                                </div>
                                                <div class="fr-col-12 fr-col-lg-8 fr-col-offset-lg-4--right fr-mb-4v">
                                ...
                                <li class="fr-nav__item">
                                    <button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-1027">Entrée mega menu</button>
                                    <div class="fr-collapse fr-mega-menu" id="mega-menu-1027">
                                        <div class="fr-container fr-container--fluid fr-container-lg">
                                            <div class="fr-grid-row fr-grid-row-lg--gutters">
                                                <div class="fr-col-12 fr-mb-n3v">
                                                    <button class="fr-btn--close fr-btn" aria-controls="mega-menu-1027" title="Fermer">
                                                        Fermer
                                                    </button>
                                                </div>
                                                <div class="fr-col-12 fr-col-lg-3">
                                ...
                                <li class="fr-nav__item">
                                    <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-1028">Entrée menu</button>
                                    <div class="fr-collapse fr-menu" id="menu-1028">
                                        <ul class="fr-menu__list">
                                            <li>
                                                <a class="fr-nav__link" href="#" target="_self">Lien de navigation</a>
                                            </li>
            ...
            <div class="fr-container fr-mt-8v">
                ...
                <h4>bouton ouverture thèmes</h4>
                <div class="fr-mb-6v">
                    <button class="fr-btn--display fr-btn" title="Paramètres d'affichage">
                        Paramètres d&#39;affichage
                    </button>
                </div>
                <div class="fr-mb-12v">
                    <section class="fr-accordion">
                        <h3 class="fr-accordion__title">
                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1029">Extrait de code</button>
                        </h3>
                        <div class="fr-collapse" id="snippet-1029">
                            <pre class=" language-html"><code>&lt;button class="fr-btn--display fr-btn" title="Paramètres d'affichage"&gt;
    Paramètres d&amp;#39;affichage
&lt;/button&gt;
</code></pre>
                        </div>
                ...
                <div class="fr-mb-12v">
                    <section class="fr-accordion">
                        <h3 class="fr-accordion__title">
                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1030">Extrait de code</button>
                        </h3>
                        <div class="fr-collapse" id="snippet-1030">
                            <pre class=" language-html"><code>&lt;dialog id="fr-theme-modal" class="fr-modal" role="dialog" aria-labelledby="fr-theme-modal-title"&gt;
...
&lt;/dialog&gt;
            ...
            <footer class="fr-footer" role="contentinfo" id="footer-1020">
                <div class="fr-container">
            ...
            <header role="banner" class="fr-header">
                        ...
                        <div class="fr-header__body-row">
                            <div class="fr-header__brand fr-enlarge-link">
                                <div class="fr-header__brand-top">
                                    ...
                                    <div class="fr-header__navbar">
                                        <button class="fr-btn--menu fr-btn" data-fr-opened="false" aria-controls="modal-1032" aria-haspopup="menu" id="button-1033" title="Menu">
                                            Menu
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="fr-header__tools">
                                <div class="fr-header__tools-links">
                                    <ul class="fr-links-group">
                                        <li>
                                            <button class="fr-link fr-fi-theme-fill fr-link--icon-left" aria-controls="fr-theme-modal" data-fr-opened="false">
                                                Paramètres d'affichage
                                            </button>
                                        </li>
                                    </ul>
                ...
                <div class="fr-header__menu fr-modal" id="modal-1032" aria-labelledby="button-1033">
                    <div class="fr-container">
                        <button class="fr-link--close fr-link" aria-controls="modal-1032">Fermer</button>
                        <div class="fr-header__menu-links">
                        </div>
                        <nav class="fr-nav" id="header-navigation" role="navigation" aria-label="Menu principal">
                            <ul class="fr-nav__list">
                                <li class="fr-nav__item">
                                    <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-1034">Entrée menu</button>
                                    <div class="fr-collapse fr-menu" id="menu-1034">
                                        <ul class="fr-menu__list">
                                            <li>
                                                <a class="fr-nav__link" href="#" target="_self">Lien de navigation</a>
                                            </li>
                                ...
                                <li class="fr-nav__item">
                                    <button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-1035">Entrée mega menu</button>
                                    <div class="fr-collapse fr-mega-menu" id="mega-menu-1035">
                                        <div class="fr-container fr-container--fluid fr-container-lg">
                                            <div class="fr-grid-row fr-grid-row-lg--gutters">
                                                <div class="fr-col-12 fr-mb-n3v">
                                                    <button class="fr-btn--close fr-btn" aria-controls="mega-menu-1035" title="Fermer">
                                                        Fermer
                                                    </button>
                                                </div>
                                                <div class="fr-col-12 fr-col-lg-8 fr-col-offset-lg-4--right fr-mb-4v">
                                ...
                                <li class="fr-nav__item">
                                    <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-1036" aria-current="true">Entrée menu active</button>
                                    <div class="fr-collapse fr-menu" id="menu-1036">
                                        <ul class="fr-menu__list">
                                            <li>
                                                <a class="fr-nav__link" href="#" target="_self">Lien de navigation</a>
                                            </li>
                                ...
                                <li class="fr-nav__item">
                                    <button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-1037">Entrée mega menu</button>
                                    <div class="fr-collapse fr-mega-menu" id="mega-menu-1037">
                                        <div class="fr-container fr-container--fluid fr-container-lg">
                                            <div class="fr-grid-row fr-grid-row-lg--gutters">
                                                <div class="fr-col-12 fr-mb-n3v">
                                                    <button class="fr-btn--close fr-btn" aria-controls="mega-menu-1037" title="Fermer">
                                                        Fermer
                                                    </button>
                                                </div>
                                                <div class="fr-col-12 fr-col-lg-8 fr-col-offset-lg-4--right fr-mb-4v">
                                ...
                                <li class="fr-nav__item">
                                    <button class="fr-nav__btn" aria-expanded="false" aria-controls="mega-menu-1038">Entrée mega menu</button>
                                    <div class="fr-collapse fr-mega-menu" id="mega-menu-1038">
                                        <div class="fr-container fr-container--fluid fr-container-lg">
                                            <div class="fr-grid-row fr-grid-row-lg--gutters">
                                                <div class="fr-col-12 fr-mb-n3v">
                                                    <button class="fr-btn--close fr-btn" aria-controls="mega-menu-1038" title="Fermer">
                                                        Fermer
                                                    </button>
                                                </div>
                                                <div class="fr-col-12 fr-col-lg-3">
                                ...
                                <li class="fr-nav__item">
                                    <button class="fr-nav__btn" aria-expanded="false" aria-controls="menu-1039">Entrée menu</button>
                                    <div class="fr-collapse fr-menu" id="menu-1039">
                                        <ul class="fr-menu__list">
                                            <li>
                                                <a class="fr-nav__link" href="#" target="_self">Lien de navigation</a>
                                            </li>
            ...
            <div class="fr-container fr-mt-8v">
                ...
                <div class="fr-mb-12v">
                    <section class="fr-accordion">
                        <h3 class="fr-accordion__title">
                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1040">Extrait de code</button>
                        </h3>
                        <div class="fr-collapse" id="snippet-1040">
                            <pre class=" language-html"><code>&lt;button class="fr-link fr-fi-theme-fill fr-link--icon-left" aria-controls="fr-theme-modal" data-fr-opened="false"&gt;
    Paramètres d'affichage
&lt;/button&gt;
</code></pre>
                        </div>
                ...
                <div class="fr-mb-12v">
                    <section class="fr-accordion">
                        <h3 class="fr-accordion__title">
                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1041">Extrait de code</button>
                        </h3>
                        <div class="fr-collapse" id="snippet-1041">
                            <pre class=" language-html"><code>&lt;dialog id="fr-theme-modal" class="fr-modal" role="dialog" aria-labelledby="fr-theme-modal-title"&gt;
    &lt;div class="fr-container fr-container--fluid fr-container-md"&gt;
        &lt;div class="fr-grid-row fr-grid-row--center"&gt;
            &lt;div class="fr-col-12 fr-col-md-6 fr-col-lg-4"&gt;
...
&lt;/dialog&gt;
            ...
            <footer class="fr-footer" role="contentinfo" id="footer-1031">
                <div class="fr-container">
                    <div class="fr-footer__body">
                        <div class="fr-footer__brand fr-enlarge-link">
                            <a href="/" title="Retour à l’accueil">
                    ...
                    <div class="fr-footer__bottom">
                        <ul class="fr-footer__bottom-list">
                            ...
                            <li class="fr-footer__bottom-item">
                                <button class="fr-fi-theme-fill fr-link--icon-left fr-footer__bottom-link" aria-controls="fr-theme-modal" data-fr-opened="false">Paramètres d'affichage</button>
                            </li>
                        </ul>
                        <div class="fr-footer__bottom-copy">
                            <p>Sauf mention contraire, tous les contenus de ce site sont sous <a href="https://github.com/etalab/licence-ouverte/blob/master/LO.md" target="_blank">licence etalab-2.0</a>
