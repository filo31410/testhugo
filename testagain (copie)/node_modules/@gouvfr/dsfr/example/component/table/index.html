...
<html lang="fr" data-fr-theme>
    ...
    <body id="top" class="fr-mb-12w">
        <div class="fr-container fr-mt-2v fr-mb-8w">
            ...
            <a href="https://gouvfr.atlassian.net/wiki/spaces/DB/pages/312016971/Tableau+-+Table" target="_blank">Documentation</a>
        </div>
        <div class="fr-mb-12w">
            <div class="fr-container">
                <h4>Tableau par défaut</h4>
                <div class="fr-mb-6v">
                    <div class="fr-table">
                        <table>
                ...
                <div class="fr-mb-12v">
                    <section class="fr-accordion">
                        <h3 class="fr-accordion__title">
                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1063">Extrait de code</button>
                        </h3>
                        <div class="fr-collapse" id="snippet-1063">
...
&lt;/div&gt;
                ...
                <div class="fr-mb-12v">
                    <section class="fr-accordion">
                        <h3 class="fr-accordion__title">
                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1064">Extrait de code</button>
                        </h3>
...
&lt;/div&gt;
                ...
                <div class="fr-mb-12v">
                    <section class="fr-accordion">
                        <h3 class="fr-accordion__title">
                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1065">Extrait de code</button>
                        </h3>
                        <div class="fr-collapse" id="snippet-1065">
...
&lt;/div&gt;
                ...
                <h4>Tableau colonnes fixées (layout-fixed)</h4>
                <div class="fr-mb-6v">
                ...
                <div class="fr-mb-12v">
                    <section class="fr-accordion">
                        <h3 class="fr-accordion__title">
                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1066">Extrait de code</button>
                        </h3>
                        <div class="fr-collapse" id="snippet-1066">
...
&lt;/div&gt;
                ...
                <h4>Tableau caption invisible</h4>
                <div class="fr-mb-6v">
                ...
                <div class="fr-mb-12v">
                    <section class="fr-accordion">
                        <h3 class="fr-accordion__title">
                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1067">Extrait de code</button>
                        </h3>
                        <div class="fr-collapse" id="snippet-1067">
...
&lt;/div&gt;
                ...
                <div class="fr-mb-12v">
                    <section class="fr-accordion">
                        <h3 class="fr-accordion__title">
                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1068">Extrait de code</button>
                        </h3>
                        <div class="fr-collapse" id="snippet-1068">
...
&lt;/div&gt;
                ...
                <div class="fr-mb-12v">
                    <section class="fr-accordion">
                        <h3 class="fr-accordion__title">
                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1069">Extrait de code</button>
                        </h3>
                        <div class="fr-collapse" id="snippet-1069">
...
&lt;/div&gt;
                ...
                <h4>Tableau accentué avec bordure</h4>
                <div class="fr-mb-6v">
                ...
                <div class="fr-mb-12v">
                    <section class="fr-accordion">
                        <h3 class="fr-accordion__title">
                            <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1070">Extrait de code</button>
                        </h3>
